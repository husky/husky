...
(cl:defmethod cl:initialize-instance :after ((m <CustomPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CustomPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name livox_ros_driver-msg:<CustomPoint> is deprecated: use livox_ros_driver-msg:CustomPoint instead.")))

(cl:ensure-generic-function 'offset_time-val :lambda-list '(m))
(cl:defmethod offset_time-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:offset_time-val is deprecated.  Use livox_ros_driver-msg:offset_time instead.")
  (offset_time m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:x-val is deprecated.  Use livox_ros_driver-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:y-val is deprecated.  Use livox_ros_driver-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:z-val is deprecated.  Use livox_ros_driver-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'reflectivity-val :lambda-list '(m))
(cl:defmethod reflectivity-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:reflectivity-val is deprecated.  Use livox_ros_driver-msg:reflectivity instead.")
  (reflectivity m))

(cl:ensure-generic-function 'tag-val :lambda-list '(m))
(cl:defmethod tag-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:tag-val is deprecated.  Use livox_ros_driver-msg:tag instead.")
  (tag m))

(cl:ensure-generic-function 'line-val :lambda-list '(m))
(cl:defmethod line-val ((m <CustomPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_ros_driver-msg:line-val is deprecated.  Use livox_ros_driver-msg:line instead.")
  (line m))
